...
namespace BackgroundTasks
{
    ...
    public sealed class FriendicaPost
    {
        ...
        private FriendicaUser _postUser;
        ...
        public FriendicaPost(string jsonString)
        {
            ...
            IJsonValue value;
            jsonObject.TryGetValue(postUserKey, out value);
            if (value != null && value.ValueType == JsonValueType.Object)
                PostUser = new FriendicaUser(jsonObject.GetNamedObject(postUserKey), null);
            else if (value != null && value.ValueType == JsonValueType.Array)
                PostUser = new FriendicaUser(jsonObject.GetNamedObject("friendica_owner"), null);
            else
                PostUser = null; 
        ...
        public FriendicaPost(JsonObject jsonObject, string Objekt)
        {
            PostText = (string)CheckAttribute(jsonObject, postTextKey, AttributeTypes.String);
            PostTruncated = jsonObject.GetNamedBoolean(postTruncatedKey, false);
            PostCreatedAt = jsonObject.GetNamedString(postCreatedAtKey, "");
        ...
        public JsonObject ToJsonObject()
        {
            ...
            FriendicaUser friendicaUser = null;
            ...
            FriendicaPost friendicaPost = null;
