...
{
    public sealed class FriendicaErrorResult
    {
        private enum AttributeTypes { String, Number, Boolean, FriendicaPost, FriendicaUser };
        ...
        public FriendicaErrorResult(string jsonString)
        {
        ...
        //public FriendicaErrorResult(JsonObject jsonObject)
        //{
        //    ErrorResult = (string)CheckAttribute(jsonObject, errorResultKey, AttributeTypes.String);
        //    ErrorMessage = (string)CheckAttribute(jsonObject, errorMessageKey, AttributeTypes.String);
        //}
