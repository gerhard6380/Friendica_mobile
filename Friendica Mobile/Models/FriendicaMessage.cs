...
namespace Friendica_Mobile.Models
{
    ...
    public FriendicaMessage(string jsonString) : this()
        {
        ...
        public FriendicaMessage(JsonObject jsonObject) : this()
        {
            MessageId = (string)CheckAttribute(jsonObject, messageIdKey, AttributeTypes.String);
            MessageSenderId = (double)CheckAttribute(jsonObject, messageSenderIdKey, AttributeTypes.Number);
            MessageText = (string)CheckAttribute(jsonObject, messageTextKey, AttributeTypes.String);
        ...
        public FriendicaMessage(FriendicaMessage message) : this()
        {
            MessageId = message.MessageId;
            MessageText = message.MessageText;
            MessageParentUri = message.MessageParentUri;
            MessageTitle = message.MessageTitle;
            MessageSenderScreenName = message.MessageSenderScreenName;
            MessageSender = message.MessageSender;
            MessageRecipientScreenName = message.MessageRecipientScreenName;
        ...
        public JsonObject ToJsonObject()
        {
            ...
            FriendicaUser friendicaSender = new FriendicaUser();
            friendicaMessageObject.SetNamedValue(messageSenderKey, friendicaSender.ToJsonObject());
            FriendicaUser friendicaRecipient = new FriendicaUser();
        ...
        {
            if (App.Settings.FriendicaUsername != null)
            {
                if (MessageSenderScreenName != null && MessageSenderScreenName.ToLower() == App.Settings.FriendicaUsername.ToLower() || MessageSenderScreenName == "Sample")
                    IsReceivedMessage = false;
                else if (MessageRecipientScreenName != null && MessageRecipientScreenName.ToLower() == App.Settings.FriendicaUsername.ToLower() || MessageRecipientScreenName == "Sample")
                    IsReceivedMessage = true;
            }
            else
            {
                if (MessageSenderScreenName != null && MessageRecipientScreenName == "Sample")
                    IsReceivedMessage = true;
                else if (MessageRecipientScreenName != null && MessageSenderScreenName == "Sample")
                    IsReceivedMessage = false;
            }
        }
        ...
        private void SetHeaderForSearchMode()
        {
            HeaderForSearchMode = MessageSenderScreenName + ": " + MessageTitle;
        }
