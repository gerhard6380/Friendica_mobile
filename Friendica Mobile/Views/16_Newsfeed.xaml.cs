...
namespace Friendica_Mobile.Views
{
    ...
    public partial class Newsfeed : BaseContentPage
    {
        public Newsfeed()
        {
            InitializeComponent();
        ...
        void ButtonIconButton_Clicked(object sender, System.EventArgs e)
        {
            ...
            if (Device.RuntimePlatform == Device.macOS)
                ScrollViewNewsfeedThreads.ScrollToAsync(0, ScrollViewNewsfeedThreads.Height, true);
            else
                ScrollViewNewsfeedThreads.ScrollToAsync(0, 0, true);
        }


        async void ScrollViewNewsfeedThreads_Scrolled(object sender, Xamarin.Forms.ScrolledEventArgs e)
        {
            ...
            if (atBottom)
            {
                var mvvm = this.BindingContext as NewsfeedViewModel;
                if (mvvm.PostsModel.NewsfeedThreads.Count > 0 && !mvvm.PostsModel.IsLoadingNext)
