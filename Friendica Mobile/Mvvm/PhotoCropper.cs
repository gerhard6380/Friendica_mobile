...
namespace Friendica_Mobile.Mvvm
{
    ...
    public sealed class PhotoCropper : Control, INotifyPropertyChanged
    {
        #region Constants
        ...
        private PhotoSelectedRegion selectedRegion;
        ...
        public static readonly DependencyProperty SourceImageProperty =
            DependencyProperty.Register("SourceImage", typeof(WriteableBitmap), typeof(PhotoCropper), new PropertyMetadata(null, OnSourceImageChanged));

        private static async void OnSourceImageChanged(DependencyObject d, DependencyPropertyChangedEventArgs e)
        {
            var that = d as PhotoCropper;
        ...
        // indicator showing that we need to save before leaving
        ...
        public PhotoCropper()
        {
            this.DefaultStyleKey = typeof(PhotoCropper);
        ...
        private async Task LoadImage(StorageFile imageFile)
        {
            ...
            else
            {
                ...
                this.sourceImage.Source = await clsCropBitmap.GetCroppedBitmapAsync(
        ...
        protected override void OnApplyTemplate()
        {
            ...
            selectedRegion = new PhotoSelectedRegion { MinSelectRegionSize = 2 * CornerSize };
        ...
        private void Corner_PointerMoved(object sender, PointerRoutedEventArgs e)
        {
            ...
            if (pointerPositionHistory.ContainsKey(ptrId) && pointerPositionHistory[ptrId].HasValue)
            {
                ...
                // changed to only observe change on x and use x change for both axis
                var side = Math.Abs(xUpdate);
        ...
        private async void UpdatePreviewImage()
        {
            ...
            this.CroppedImage = await clsCropBitmap.GetCroppedBitmapAsync(
                   this.sourceImageFile,
