...
namespace Friendica_Mobile.PCL
{
    public class HtmlToXml
    {
        ...
        public List<string> formatEntities = new List<string>(new string[] { "em", "b", "u", "i", "strong", "#text", "span" });
        ...
        public async Task<string> TransformHtmlToXml(string html)
        {
            return await TransformHtmlToXmlHelper(html);
        }
